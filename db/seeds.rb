...
e1 = Event.create(
  ...
  time: DateTime.new(2017, 7, 4, 10, 0, 0),
...
e3 = Event.create(
  ...
  time: DateTime.new(2017, 10, 8, 7, 0, 0),
...
e4 = Event.create(
  ...
  time: DateTime.new(2017,8,14,14,0,0),
...
e5 = Event.create(
    ...
    time: DateTime.new(2017,9,22,19,0,0),
...
e6 = Event.create(
    ...
    time: DateTime.new(2017,10,25,19,0,0),
